...
void step1() {
  ...
  const line1 = 'firebase_core: ^1.19.1';
  const line2 = 'firebase_messaging: ^11.4.4';
  const line3 = 'flutter_local_notifications: ^9.6.1';
...
// Rename 'fcm_service.off' file to 'fcm_service.dart'.
void step3() {
