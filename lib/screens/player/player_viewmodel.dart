...
class PlayerViewModel with ChangeNotifier {
  ...
  String get artist => metadata?[0] ?? _greeting;
  String get track => metadata?[1] ?? Config.title;
  String get cover => metadata?[2] ?? 'https://hiphopkr.com/wp-content/uploads/2020/11/sudi-on-the-radio.jpg';
